...
The cameras were calibrated using the following equations and stereo images of a checkered plane submerged in a pool.  These two values used to specify the behavior of projectors, discussed in Section~\ref{subsec:projectiveTexturing}.:
\begin{align}
