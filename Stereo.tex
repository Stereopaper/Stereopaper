...
This paper outlines the data acquisition and stereo displacement map computation, describes our solution to displacing rough geometry in accordance with a projected disparity map, illustrates our results on a model using a partial  data set, and outlines a data acquisition process for future missions. The goal of this work is the generation of a computer model which includes the fine organic features found in underwater storage systems.
...
The second step towards to building a more accurate geometric model requires the use of the disparity maps and image pairs to deform and texture, respectively, the basic sonar mesh.
...
For the current implementation, the first challenge remains unresolved. The location of the ROV is unknown without better data acquisiton techniques such as a Smart Tether system, or an implementation of stereo SLAM.
Instead, the preliminary results presented in this paper are from a cylindrical well with rotational symmetry.
...
Unfortunately, few of these algorithms are robust enough to handle compressed underwater images of rock walls combined with poor lighting conditions and very shallow features.
...
The images captured within the cisterns usually contain minimal color variation, poor lighting, and shallow depressions (in comparison to images with large color or depth contrast).
Rocks and bricks, two common features found on cistern walls, have highly repetitive patterns and colors--providing only a few unique features.
...
\begin{figure}[!h]
	\vspace{-0.2cm}
	\centering
		\epsfig{file = pics/400kUpClose.png, width = 7cm}
...
\begin{figure*}[!ht]
   \vspace{-0.2cm}
   \centering{
      \epsfig{file = pics/400kCompositePic.png, width = .9\textwidth}}
   \caption{View of depth and color data mapped onto part of the general mesh from the virtual camera. The fine details added by the vertex displacements and recalculated lighting create a better geometric model of the walls of the well.}
...
\bibitem[Clark et~al., 2008]{Clark2008b}
...
\bibitem[Fairfield et~al., 2010]{Fairfield:2010}
...
\bibitem[Fairfield et~al., 2005]{Fairfield2005}
...
\bibitem[Fairfield et~al., 2006]{Fairfield2006}
...
\bibitem[Forney et~al., 2011]{ICEX11}
...
\bibitem[Hernˆndez et~al., 2009]{harbor}
...
\bibitem[Hiranandani et~al., 2009]{ClarkVast}
...
\bibitem[Lorensen and Cline, 1987]{Lorensen}
...
\bibitem[McVicker et~al., 2012a]{McVicker2}
...
\bibitem[McVicker et~al., 2012b]{McVicker}
McVicker, W., Forrester, J., Nelson, E., Gambin, T., Lehr, J., Wood, Z., and
  Clark, C. (2012b).
\newblock Mapping and visualizing ancient water storage systems with an rov -
  an approach based on fusing stationy scans within a particle filter.

\bibitem[Nalpantidis and Gasteratos, 2009]{stereo:nalGast}
Nalpantidis, L. and Gasteratos, A. (2009).
\newblock Stereo vision for robotic applications in the presence of non-ideal
  lighting conditions.
\newblock (28).

\bibitem[Pizarro et~al., 2009]{opizarro-2009a}
...
\bibitem[Segal et~al., 1992]{Segal}
...
\bibitem[White et~al., 2010]{White10}
...
\bibitem[Williams et~al., 2009]{Williams09}
...
\bibitem[Zitnick and Kanade, 1999]{stereo:zitKan}
