...
%TP: 
An important step in any meaningful measrument, including disparity mapping, is calibration.
...
That equation is used later to accurately recreate the internal dimentions of the cistern, see section ~\ref{Vertex Displacement} for more info.
...
These erronious errors were fixed by flooring and capping the intensity of the pixels. 
...
The feature-less, poorly lit, and repetative underwater enviornment required us to use a very large serch window when matching points between images.  
In future, a better hardware setup could provide more detailed results of this enviornment.
