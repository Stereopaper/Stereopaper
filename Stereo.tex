...
%->Removed \addtocmark{Hamiltonian Mechanics} % additional mark in the TOC
%
%
...
%                                     \toctitle is used
%
\author{Timothy M. Peters} %\thanks{These authors contributed equally to this work.}$_1$,  Erik A. Nelson\thanksmark{1}$_1$, Tyler Vitti$_1$, Timothy Gambin$_2$, Christopher M. Clark$_3$, Zo\"{e} J. Wood$_1$ 
%Computer Engineering & Materials Engineering & Computer Engineering & Archeology & Computer Science & Computer Science 
%$_1$California Polytechnic State University, $_2$University of Malta, $_3$Harvey Mudd College 
...
\keywords{stereoscopic vision, surface reconstruction, projective texture mapping, underwater mapping, NEED ONE MORE}
\end{abstract}
%
