...
In addition, this work relies on related work in the field of stereoscopic data acquisition and disparity map reconstruction~\cite{stereo:gutMarroquin},~\cite{stereo:scharsteinSzeliski}.
  ...
  We also consulted the work of ~\cite{stereo:nalpantidis2010stereo} to compensate for differences in light intensities between images.
  This paper explores the conversion of images into the HSL color space in an attempt to remove light intensity from the equation and compare soley at hue and saturation values.
...
\begin{figure}[!h]
	\centering
		...
		\caption{A set of images and disparity maps reprojected as they were captured inside the well. <INSERT well site name>}
		\label{fig:result2}
\end{figure}
